...
$$.main_anon = {"": "Closure;",
  call$1: function(e) {
    $.mouseListener = $.canvas.get$onMouseMove().listen$1($.mouseMoveHandler);
    $.mouseDownAtX = e.get$x();
    $.mouseDownAtY = e.get$y();
  }
};

$$.main_anon0 = {"": "Closure;",
  call$1: function(e) {
    $.mouseListener.cancel$0();
  }
};
...
$.main = function() {
  ...
  var t1 = $.ctx;
  t1.set$fillStyle("cornflowerblue");
  ...
  $.canvas.get$onMouseUp().listen$1(new $.main_anon0());
  ...
  $.image.set$src("./resource/waterfall.png");
  ...
  $.image.get$onLoad().listen$1(new $.main_anon1());
};

$.run = function(time) {
  $.ctx.drawImage$3($.image, 33, 33);
};
...
$.mouseMoveHandler = function(e) {
  ...
  x = e.get$clientX();
  y = e.get$clientY();
  $.ctx.clearRect$4(0, 0, $.canvas.get$width(), $.canvas.get$height());
  $.ctx.drawImage$3($.image, $.$$sub(x, $.mouseDownAtX), $.$$sub(y, $.mouseDownAtY));
};

$.sliderOnChange = function(e) {
  var value, percent, t1, fontsize, w, h, sw, t2, sh;
  value = $.scaleSlider.get$valueAsNumber();
  percent = $.$$div($.$$sub(value, 0.1), 9.9);
  t1 = "<div>" + $.S(value) + "</div>";
  $.scaleOutput.set$innerHtml(t1);
  if ($.$$lt(percent, 0.35) === true)
    percent = 0.35;
  fontsize = $.S($.$$div($.$$mul(percent, 10), 1.5)) + " em";
  $.scaleOutput.get$style().set$fontSize(fontsize);
  $.Primitives_printString("value = " + $.S(value) + "; percent = " + $.S(percent) + " - fontsize = " + fontsize);
  w = $.canvas.get$width();
  h = $.canvas.get$height();
  t1 = $.getInterceptor$JSNumber(w);
  sw = t1.$mul(w, $.scale);
  t2 = $.getInterceptor$JSNumber(h);
  sh = t2.$mul(h, $.scale);
  $.ctx.clearRect$4(0, 0, $.canvas.get$width(), $.canvas.get$height());
  $.ctx.drawImage$5($.image, $.$$add($.$$div($.$$negate(sw), 2), t1.$div(w, 2)), $.$$add($.$$div($.$$negate(sh), 2), t2.$div(h, 2)), sw, sh);
};
...
$.$defineNativeClass("HTMLInputElement", {"": "height=,pattern>,src<,value=,valueAsNumber>,width=",
  $isElement: function() {
    return true;
  },
  $isNode: function() {
