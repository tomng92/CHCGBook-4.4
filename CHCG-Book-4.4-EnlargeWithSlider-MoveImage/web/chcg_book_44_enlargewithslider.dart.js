...
$$.main_anon = {"": "Closure;",
  call$1: function(e) {
    $.mouseMoveListener = $.canvas.get$onMouseMove().listen$1($.mouseMoveHandler);
    $.mouseDownAtX = e.get$clientX();
    $.mouseDownAtY = e.get$clientY();
  }
};
...
$.main = function() {
  ...
  var t1 = $.ctx;
  t1.set$fillStyle("dashed");
  t1.set$strokeStyle("yellow");
  t1.set$shadowColor("rgba(50, 50, 50, 1.0)");
  t1.set$shadowOffsetX(5);
  t1.set$shadowOffsetY(5);
  t1.set$shadowBlur(10);
  $.canvas.get$onMouseDown().listen$1(new $.main_anon());
  $.canvas.get$onMouseOut().listen$1($.onMouseUpOrOut);
  $.canvas.get$onMouseUp().listen$1($.onMouseUpOrOut);
  $.scaleSlider = document.query$1("#scaleSlider");
  $.scaleOutput = document.query$1("#scaleOutput");
  $.scaleSlider.get$onChange().listen$1($.sliderOnChange);
  $.image = $.ImageElement_ImageElement(null, null, null);
  $.image.set$src("http://maps.googleapis.com/maps/api/staticmap?center=Brooklyn+Bridge,New+York,NY&zoom=13&size=900x500&maptype=roadmap&markers=color:blue%7Clabel:S%7C40.702147,-74.015794&markers=color:green%7Clabel:G%7C40.711614,-74.012318&markers=color:red%7Ccolor:red%7Clabel:C%7C40.718217,-73.998284&sensor=false");
  $.image.get$onLoad().listen$1(new $.main_anon0());
};
...
$.render = function() {
  var ratio, t1;
  $.Primitives_printString("canvas: " + $.S($.canvas.get$width()) + " vs " + $.S($.canvas.get$clientWidth()) + " -- image: " + $.S($.image.get$width()));
  ratio = $.$$div($.image.get$width(), $.image.get$height());
  t1 = $.$$add($.image.get$width(), 20);
  $.canvas.set$width(t1);
  t1 = $.image.get$height();
  if (typeof ratio !== "number")
    throw $.iae(ratio);
  t1 = $.$$add(t1, $.CONSTANT11.toInt$0(20 / ratio));
  $.canvas.set$height(t1);
  $.ctx.drawImage$3($.image, 0, 0);
};

$.onMouseUpOrOut = function(e) {
  var t1;
  if ($.$$eq(e.get$type(), "mouseout") !== true && !($.mouseMoveListener == null)) {
    $.lastPosX = $.$$add($.lastPosX, $.$$sub(e.get$clientX(), $.mouseDownAtX));
    $.lastPosY = $.$$add($.lastPosY, $.$$sub(e.get$clientY(), $.mouseDownAtY));
    $.Primitives_printString("onMouseUpOrOut: " + $.S(e.get$type()) + "  imagePos:[" + $.S($.imagePosX) + ", " + $.S($.imagePosY) + "] lastPos:[" + $.S($.lastPosX) + ", " + $.S($.lastPosY) + "]");
  }
  t1 = $.mouseMoveListener;
  if (!(t1 == null)) {
    t1.cancel$0();
...
$.mouseMoveHandler = function(e) {
  $.imagePosX = $.$$add($.$$sub(e.get$clientX(), $.mouseDownAtX), $.lastPosX);
  $.imagePosY = $.$$add($.$$sub(e.get$clientY(), $.mouseDownAtY), $.lastPosY);
  $.doDrawImage();
};

$.sliderOnChange = function(e) {
  var t1;
  $.scaleValue = $.scaleSlider.get$valueAsNumber();
  t1 = "<div>" + $.S($.scaleValue) + "</div>";
  $.scaleOutput.set$innerHtml(t1);
  $.Primitives_printString("sliderOnChange:   imagePos:[" + $.S($.imagePosX) + ", " + $.S($.imagePosY) + "] lastPos:[" + $.S($.lastPosX) + ", " + $.S($.lastPosY) + "]");
  $.doDrawImage();
};
...
$.doDrawImage = function() {
  ...
  sw = $.$$mul(w, $.scaleValue);
  sh = $.$$mul(h, $.scaleValue);
  $.ctx.clearRect$4(0, 0, w, h);
  $.ctx.drawImage$5($.image, $.imagePosX, $.imagePosY, sw, sh);
  $.drawFrame();
};
...
$.drawFrame = function() {
  ...
  sh = $.$$mul(h, $.scaleValue);
  $.ctx.beginPath$0();
  $.ctx.strokeRect$5($.imagePosX, $.imagePosY, sw, sh, 1);
  $.ctx.stroke$0();
};
...
$.run.call$1 = $.run;
$.run.$name = "run";
$.onMouseUpOrOut.call$1 = $.onMouseUpOrOut;
$.onMouseUpOrOut.$name = "onMouseUpOrOut";
$.mouseMoveHandler.call$1 = $.mouseMoveHandler;
$.mouseMoveHandler.$name = "mouseMoveHandler";
$.sliderOnChange.call$1 = $.sliderOnChange;
$.sliderOnChange.$name = "sliderOnChange";
...
$.$defineNativeClass("CanvasRenderingContext2D", {"": "fillStyle<,shadowBlur<,shadowColor<,shadowOffsetX<,shadowOffsetY<,strokeStyle<",
...
$.$defineNativeClass("Element", {"": "$$dom_children:children~,id>,innerHtml:innerHTML|,clientWidth>,$$dom_lastElementChild:lastElementChild~",
  get$children: function() {
...
$.$defineNativeClass("HTMLInputElement", {"": "height=,pattern>,src<,type>,value=,valueAsNumber>,width=",
  $isElement: function() {
    return true;
  },
  $isNode: function() {
...
//@ sourceMappingURL=chcg_book_44_enlargewithslider.dart.js.map
